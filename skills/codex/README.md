...
Vendored from the upstream [claude-code-codex-skill](https://github.com/tomc98/claude-code-codex-skill) (MIT).
...
<!-- CUSTOMIZE: pick the model and reasoning effort that match your Codex plan and budget. -->
